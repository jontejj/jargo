...
public abstract class CommandLineParser
{
	...
	@Nonnull
	public final ParsedArguments parse(@Nonnull final Iterator<String> actualArguments) throws ArgumentException
	{
		return parse(newArrayList(actualArguments));
	}

	@Nonnull
	public final ParsedArguments parse(@Nonnull final Iterable<String> actualArguments) throws ArgumentException
	{
		return parse(newArrayList(actualArguments));
	}

	@Nonnull
	public final ParsedArguments parse(@Nonnull final String ... actualArguments) throws ArgumentException
	{
		return parse(newArrayList(actualArguments));
	}
	...
	@CheckReturnValue
	@Nonnull
	public abstract String usage(@Nonnull final String programName);

	@Nonnull
	abstract ParsedArguments parse(@Nonnull Arguments actualArguments) throws ArgumentException;
	...
	private static final class DefaultArgumentParser extends CommandLineParser
	{
		...
		@Override
		@Nonnull
		public ParsedArguments parse(@Nonnull Arguments arguments) throws ArgumentException
		{
		...
		private void parseArgument(@Nonnull final Arguments actualArguments, @Nonnull final ParsedArgumentHolder holder) throws ArgumentException
		{
	...
	/**
	 * A container for parsed arguments output by {@link CommandLineParser#parse(String...)}.
	...
	private static final class IgnoringCommandLineParser extends CommandLineParser
	{
		...
		@Override
		public ParsedArguments parse(Arguments actualArguments) throws ArgumentException
		{
