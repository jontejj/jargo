...
public final class Arguments
{
	...
	/**
	 * Creates an {@link Argument} that parses {@link DateTime dates} with the {@link DateTimeZone#getDefault() default timezone} and the {@link ISODateTimeFormat#dateOptionalTimeParser()}.
	 *
	...
	{
		return se.softhouse.jargo.Arguments.withParser(new DateTimeParser(DateTimeZone.getDefault())).defaultValueDescription("Current time").names(names);
	}

	/**
	 * Creates an {@link Argument} that parses {@link DateTime dates} with the provided {@link DateTimeZone#getDefault() timezone}.
	 *
	 * @param names the {@link ArgumentBuilder#names(String...) names} to use
	 */
