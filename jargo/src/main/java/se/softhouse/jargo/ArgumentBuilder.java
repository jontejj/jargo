...
import static se.softhouse.comeon.guavaextensions.Functions2.listTransformer;
import static se.softhouse.comeon.guavaextensions.Predicates2.listPredicate;
import static se.softhouse.comeon.strings.Descriptions.EMPTY_STRING;
import static se.softhouse.comeon.strings.Descriptions.withString;
...
public abstract class ArgumentBuilder<SELF extends ArgumentBuilder<SELF, T>, T>
{
	 ...
	 * <b>Note:</b> the surrounding < & > aren't enforced or added automatically but it's preferred
